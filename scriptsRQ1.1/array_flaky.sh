...
csv_line=`sed "${n}q;d" /scratch/grelka/scriptsRQ1.1/repos.csv`
...
mkdir -p /scratch/grelka/flakyanalysis/run
outfile="/scratch/grelka/flakyanalysis/run/${repository}-out.txt"
errfile="/scratch/grelka/flakyanalysis/run/${repository}-err.txt"
